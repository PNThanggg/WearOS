package com.pnt.watch_face.data
...
enum class ColorStyleIdAndResourceIds(
    ...
    companion object {
        /**
         * Translates the string id to the correct com.pnt.watch_face.presentation.data.ColorStyleIdAndResourceIds object.
         */
         ...
         * com.pnt.watch_face.presentation.data.ColorStyleIdAndResourceIds enums. The watch face settings APIs use this to set up
