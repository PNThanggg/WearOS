...
fun createUserStyleSchema(context: Context): UserStyleSchema {
    ...
    val colorStyleSetting = UserStyleSetting.ListUserStyleSetting(
        ...
        listOf(
            WatchFaceLayer.BASE, WatchFaceLayer.COMPLICATIONS, WatchFaceLayer.COMPLICATIONS_OVERLAY
        )
    )
    ...
    return UserStyleSchema(
        listOf(
            colorStyleSetting, drawHourPipsStyleSetting, watchHandLengthStyleSetting
        )
    )
}